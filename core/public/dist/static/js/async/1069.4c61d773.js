...
`,[(0,f.cE)("border",`
 ...
 padding-right: 24px;
 `)])]),(0,f.cE)("icon",{color:"var(--n-icon-color)"}),(0,f.cB)("alert-body",{padding:"var(--n-padding)"},[(0,f.cE)("title",{color:"var(--n-title-text-color)"}),(0,f.cE)("content",{color:"var(--n-content-text-color)"})]),(0,k.Y)({originalTransition:"transform .3s var(--n-bezier)",enterToProps:{transform:"scale(1)"},leaveToProps:{transform:"scale(0.9)"}}),(0,f.cE)("icon",`
 position: absolute;
 left: 0;
 top: 0;
 align-items: center;
